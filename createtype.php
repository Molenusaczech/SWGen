...
<div id="config">
    ...
    První jména hrdinů (odděl čárkou) <textarea id="names" rows="4" cols="50" onChange=updateCard()>Lord, Lady, Mistr</textarea>
    Druhá jména hrdinů (odděl čárkou) <textarea id="surnames" rows="4" cols="50" onChange=updateCard()>Boss, Scratch, Kombo</textarea>
    <br>
Druh hrdiny: <input id="typeInput" type="text" onChange=updateCard() value="Druh hrdiny">
<br>
Životy hrdiny: <input id="hpInputMin" type="number" min="1" max="99" onChange=updateCard() value=10>
- <input id="hpInputMax" type="number" min="1" max="99" onChange=updateCard() value=99>  

Týmové životy hrdiny: <input id="teamHpInputMin" type="number" min="1" max="9" onChange=updateCard() value=1>
- <input id="teamHpInputMax" type="number" min="1" max="9" onChange=updateCard() value=9>
<br>
...
<br>
Energie: <input id="energInput1Min" type="number" min="1" max="9" onChange=updateCard() value=1>
- <input id="energInput1Max" type="number" min="1" max="9" onChange=updateCard() value=9>
<br>
<input id="energInput2Min" type="number" min="1" max="9" onChange=updateCard() value=2>
- <input id="energInput2Max" type="number" min="1" max="9" onChange=updateCard() value=9>
<br>
<input id="energInput3Min" type="number" min="1" max="9" onChange=updateCard() value=3>
- <input id="energInput3Max" type="number" min="1" max="9" onChange=updateCard() value=9>
<br>
<input id="energInput4Min" type="number" min="1" max="9" onChange=updateCard() value=4>
- <input id="energInput4Max" type="number" min="1" max="9" onChange=updateCard() value=9>
<br>
<div id="prvnidoba">
    ...
    <input id="valueInput1Min" type="number" min="-9" max="9" onChange=updateCard() value=2>
    <input id="valueInput1Max" type="number" min="-9" max="9" onChange=updateCard() value=2>
    <br>
    ...
    <input id="valueInput2Min" type="number" min="-9" max="9" onChange=updateCard() value=-1>
    <input id="valueInput2Max" type="number" min="-9" max="9" onChange=updateCard() value=-1>
</div>
...
<select id="effectInput3" class="select" onChange=updateCard()>
    ...
    <input id="valueInput3Min" type="number" min="-9" max="9" onChange=updateCard() value=1>
    <input id="valueInput3Max" type="number" min="-9" max="9" onChange=updateCard() value=1>
    <br>
    ...
    <input id="valueInput4Min" type="number" min="-9" max="9" onChange=updateCard() value=3>
    <input id="valueInput4Max" type="number" min="-9" max="9" onChange=updateCard() value=3>
...
<select id="effectInput5" class="select" onChange=updateCard()>
    ...
    <input id="valueInput5Min" type="number" min="-9" max="9" onChange=updateCard() value=2>
    <input id="valueInput5Max" type="number" min="-9" max="9" onChange=updateCard() value=2>
    <br>
    ...
    <input id="valueInput6Min" type="number" min="-9" max="9" onChange=updateCard() value=-2>
    <input id="valueInput6Max" type="number" min="-9" max="9" onChange=updateCard() value=-2>
...
<select id="effectInput7" class="select" onChange=updateCard()>
    ...
    <input id="valueInput7Min" type="number" min="-9" max="9" onChange=updateCard() value=3>
    <input id="valueInput7Max" type="number" min="-9" max="9" onChange=updateCard() value=3>
    <br>
    ...
    <input id="valueInput8Min" type="number" min="-9" max="9" onChange=updateCard() value=3>
    <input id="valueInput8Max" type="number" min="-9" max="9" onChange=updateCard() value=3>

</div>
<br>
<button id="updateButton" onClick=updateCard()>Generovat!</button>
...
if (isset($_SESSION['user'])) {
    ...
    echo '    <select id="islandSelect">';

    $data = file_get_contents("../storage/data.json");
    $data = json_decode($data, true);
    $islands = $data[$_SESSION['user']]['islands'];
